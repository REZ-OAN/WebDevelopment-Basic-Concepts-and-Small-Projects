...
// get all the todos
// to protect this route you have to use 
// middleware that checks for the token validation
// or means authentication
// we know how middleware works 
// so we will add a middleware before accessing any routes
